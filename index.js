...
menuItems.forEach((item, index) => {         
    item.addEventListener("click", () => {
        ...
        //assign new colors
        currentProductColors.forEach((color, index) => {     // new color options -> the two boxes of different color options
            color.style.backgroundColor = choosenProduct.colors[index].code;
        });
    });
});

currentProductColors.forEach((color,index)=>{         //this is to get each shoose in 2 options
